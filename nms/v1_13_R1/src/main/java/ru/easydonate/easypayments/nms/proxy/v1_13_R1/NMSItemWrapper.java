package ru.easydonate.easypayments.nms.proxy.v1_13_R1;
...
public final class NMSItemWrapper extends AbstractItemWrapper {
    ...
    public @NotNull Optional<String> getNbtString(@NotNull String key) {
        ...
        return nbtTag instanceof NBTTagString ? Optional.of(nbtTag.b_()) : Optional.empty();
    }

    @Override
    public @NotNull OptionalInt getNbtInt(@NotNull String key) {
        NBTBase nbtTag = getNbtTag(key);
        return nbtTag instanceof NBTNumber ? OptionalInt.of(((NBTNumber) nbtTag).e()) : OptionalInt.empty();
    }
