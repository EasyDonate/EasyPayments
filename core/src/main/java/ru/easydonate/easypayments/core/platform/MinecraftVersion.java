...
public final class MinecraftVersion implements Comparable<MinecraftVersion>, Serializable {
    ...
    /**
     * Version 1.20.6 - the minimal version for Folia support
     */
    public static final MinecraftVersion FOLIA_SUPPORTED_UPDATE = new MinecraftVersion("1.20.6");
     ...
     */
    public MinecraftVersion(@NotNull Server server) {
     ...
     */
    public MinecraftVersion(@NotNull String versionOnly) {
     ...
     */
    private MinecraftVersion(@NotNull String versionOnly, boolean parseSnapshot) {
        ...
        try {
            ...
            try {
                ...
                throw new IllegalStateException("Cannot parse " + section[0], ex);
            }
        }
     ...
     */
    public MinecraftVersion(int major, int minor, int build, @Nullable String development) {
        this.major = major;
        this.minor = minor;
        this.build = build;
    ...
    private @NotNull int[] parseVersion(@NotNull String version) {
