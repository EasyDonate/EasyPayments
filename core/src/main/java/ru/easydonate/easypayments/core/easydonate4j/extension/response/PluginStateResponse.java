package ru.easydonate.easypayments.core.easydonate4j.extension.response;
...
public final class PluginStateResponse extends GsonApiResponse<PluginStateModel> {
